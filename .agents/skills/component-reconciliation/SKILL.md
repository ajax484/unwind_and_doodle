---
name: component-reconciliation
description: >-
  Use this skill whenever reconciling a design-system component between Figma,
  React, and Storybook (e.g., executing a Component Reconciliation Template,
  aligning component variants, auditing tokens, verifying accessibility, or
  generating a Step 7C reconciliation report).
---

# Design System Component Reconciliation Workflow

Standardized procedure for reconciling React component implementations with canonical Figma design system specifications and Storybook interactive representations.
